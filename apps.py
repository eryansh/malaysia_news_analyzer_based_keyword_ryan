...
def analyze_with_llm(titles):
    ...
    {{
        ...
        "deep_summary": "Tulis satu rumusan (800 hingga 1000 patah perkataan) bergaya penceritaan (storytelling) yang sangat menarik, mengalir (flow) dengan baik, dan tidak berulang-ulang. Gunakan gaya bahasa kewartawanan atau majalah yang memikat pembaca, menceritakan jatuh bangun, cabaran, dan pencapaian berkaitan topik ini dalam 4 hingga 5 perenggan yang padat.",
